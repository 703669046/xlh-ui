<template>
    <div>
        ...
        <section class="sample">
            <x-link href="http://xlh-ui.codehauler.cn" target="_blank">默认链接</x-link>
        ...
        <h2>禁用</h2>
        <section class="sample">
            <x-link href="http://xlh-ui.codehauler.cn" target="_blank" disabled>默认链接</x-link>
        ...
        <h2>下划线</h2>
        <section class="sample">
            <x-link type="primary" :undline="false">主要链接</x-link>
            <x-link type="success" :undline="false">成功链接</x-link>
            <x-link type="warning" :undline="false">警告链接</x-link>
            <x-link type="danger" :undline="false">危险链接</x-link>
            <x-link type="info" :undline="false">信息链接</x-link>
            <el-row>
                <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <docu-block :height="160">
                        <md-linkDisabled></md-linkDisabled>
